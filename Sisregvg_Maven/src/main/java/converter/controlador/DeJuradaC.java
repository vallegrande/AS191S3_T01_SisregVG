...
public class DeJuradaC implements Serializable {
    ...
    public void registrar() throws Exception {
        try {
            declaracion.setNomper(dao.obtenerNomper(declaracion.getNomper()));          
    ...
    public void eliminar() throws Exception {
     ...
     public List<String> completeTextDeJurada(String query) throws SQLException, Exception {
...
//metodos generados
    ...
    public void setListadoDec(List<DeJurada> listadoDec) {
