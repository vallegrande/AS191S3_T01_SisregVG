...
//        String celu = "974862031";
    ...
    //parametersList.add(new BasicNameValuePair("domainId", "XX"));
        parametersList.add(new BasicNameValuePair("login", ""));
        parametersList.add(new BasicNameValuePair("passwd", ""));
...
//        parametersList.add(new BasicNameValuePair("dest", "51" + celu));
        parametersList.add(new BasicNameValuePair("msg", "Hola  monitor,bienvenido a SISREGVG su usuario es su dni y su contraseña de ingreso a la plataforma es @Personal2021@"));
